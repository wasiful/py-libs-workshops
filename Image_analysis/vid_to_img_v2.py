...
def stack_video_frames(video_path, output_image_path, target_fps=None, duration=None):
    ...
    while frame_count < max_frame_count:
        ...
        if frame_count % frame_interval == 0:
            ...
            processed_frames += 1
            print(f"Stacking frame {frame_count}/{max_frame_count}...")

        frame_count += 1

    # Average out the stack to get the final image
    frame_stack /= processed_frames
...
# Example usage with target FPS and duration control
stack_video_frames('Image_analysis/input_video.mp4', 'stacked_output_image.jpg', target_fps=2, duration=10)
